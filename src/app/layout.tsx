...
export const metadata: Metadata = {
  title: "SuperCoffee - Premium Specialty Coffee",
  description: "Discover exceptional specialty coffee at SuperCoffee. Ethically sourced beans, expert baristas, and a welcoming community. Visit us today.",
  keywords: "coffee shop, specialty coffee, espresso, cappuccino, artisan coffee, sustainable sourcing",
  openGraph: {
    title: "SuperCoffee - Premium Specialty Coffee",
    description: "Exceptional coffee crafted with passion from the finest beans around the world.",
    siteName: "SuperCoffee",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763980048191-xb02n0ug.jpg",
        alt: "SuperCoffee Premium Coffee"
      }
    ]
  },
  twitter: {
    ...
    title: "SuperCoffee - Premium Specialty Coffee",
    description: "Exceptional coffee crafted with passion. Visit SuperCoffee today.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763980048191-xb02n0ug.jpg"]
  },
  robots: {
    index: true,
    follow: true
